...
<ProcessExtensionScenario xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://sap.com/ByD/PDI/ProcessExtensionScenarioDefinition">
  ...
  <ExtensionScenarioList xmlns="">
    ...
    <ExtensionScenario>
      <scenario_name>9E9CD2A0ED4D01D8B4B2BBD8840618</scenario_name>
      <scenario_description>Customer Contract ( Service name CustomerContractProcessingMigrationIn and operation name MaintainBundle and direction Inbound )</scenario_description>
      <service_interface_type>INBOUND_EXTEXP_MIG</service_interface_type>
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUCO_MIG_IN</reference_field_bundle_key>
    ...
    <ExtensionScenario>
      <scenario_name>BD5351557075E63411677EA4E8FF8B</scenario_name>
      <scenario_description>Customer Contract ID ( Service name QueryCustomerContractIn and operation name FindByElements and direction Outbound )</scenario_description>
      <service_interface_type>INBOUND</service_interface_type>
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUSTOMER_CONTRACT_QUERY_IN</reference_field_bundle_key>
              <reference_field_name>CUSTOMER_CONTRACT-ROOT</reference_field_name>
            </reference_field_key>
          </reference_field_keys>
        </Flow>
    ...
    <ExtensionScenario>
      <scenario_name>CRM_CONTR_2_CONTR_ROOT</scenario_name>
      <scenario_description>Customer Contract Template - General Information to Customer Contract - General Information</scenario_description>
      <service_interface_type />
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          <bo_connection_order>1</bo_connection_order>
          <bo_connection_description>Contract Template - General Information --&gt; Contract - General Information</bo_connection_description>
          <source_bo_name>CUSTOMER_CONTRACT_TEMPLATE</source_bo_name>
          <source_bo_node_name>ROOT</source_bo_node_name>
          <is_source_hidden>false</is_source_hidden>
          <target_bo_name>CUSTOMER_CONTRACT</target_bo_name>
          <target_bo_node_name>ROOT</target_bo_node_name>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUCT_2_CUCO_BO</reference_field_bundle_key>
              <reference_field_name>CUSTOMER_CONTRACT_TEMPLATE-ROOT-CUSTOMER_CONTRACT-ROOT</reference_field_name>
            </reference_field_key>
          </reference_field_keys>
        </Flow>
      </bo_connections>
    ...
    <ExtensionScenario>
      <scenario_name>CRM_CONTR_2_SCO_ROOT</scenario_name>
      <scenario_description>Customer Contract - General Information to Service Confirmation - General Information</scenario_description>
      <service_interface_type />
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          <bo_connection_order>1</bo_connection_order>
          <bo_connection_description>Contract - General Information --&gt; Service Confirmation - General Information</bo_connection_description>
          <source_bo_name>CUSTOMER_CONTRACT</source_bo_name>
          <source_bo_node_name>ROOT</source_bo_node_name>
          <is_source_hidden>false</is_source_hidden>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUCO_2_SRVC_BO</reference_field_bundle_key>
              <reference_field_name>CUSTOMER_CONTRACT-ROOT-SERVICE_CONFIRMATION-ROOT</reference_field_name>
            </reference_field_key>
          </reference_field_keys>
        </Flow>
      </bo_connections>
    ...
    <ExtensionScenario>
      <scenario_name>CRM_CONTR_2_SRQ_ROOT</scenario_name>
      <scenario_description>Customer Contract - General Information to Service Request - General Information</scenario_description>
      <service_interface_type />
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          <bo_connection_order>1</bo_connection_order>
          <bo_connection_description>Contract - General Information --&gt; Service Request - General Information</bo_connection_description>
          <source_bo_name>CUSTOMER_CONTRACT</source_bo_name>
          <source_bo_node_name>ROOT</source_bo_node_name>
          <is_source_hidden>false</is_source_hidden>
          <target_bo_name>SERVICE_REQUEST</target_bo_name>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUCO_2_SRRQ_BO</reference_field_bundle_key>
              <reference_field_name>CUSTOMER_CONTRACT-ROOT-SERVICE_REQUEST-ROOT</reference_field_name>
            </reference_field_key>
          </reference_field_keys>
        </Flow>
      </bo_connections>
    ...
    <ExtensionScenario>
      <scenario_name>FIN_CC_2_FAV_SDOC_RT</scenario_name>
      <scenario_description>Customer Contract- General Information to Financial Accounting View of Sales and Service Document - General Information</scenario_description>
      <service_interface_type />
      <is_selected>false</is_selected>
      <bo_connections>
        <Flow>
          <bo_connection_order>1</bo_connection_order>
          <bo_connection_description>Contract - General Information --&gt; Business Transaction (For Accounting) - Accounting Notification</bo_connection_description>
          <source_bo_name>CUSTOMER_CONTRACT</source_bo_name>
          <source_bo_node_name>ROOT</source_bo_node_name>
          <is_source_hidden>false</is_source_hidden>
          ...
          <reference_field_keys>
            <reference_field_key>
              <reference_field_bundle_key>CRM_CUCO_SAPAN_OUT</reference_field_bundle_key>
              <reference_field_name>CUSTOMER_CONTRACT-ROOT</reference_field_name>
            </reference_field_key>
            <reference_field_key>
        ...
        <Flow>
          <bo_connection_order>2</bo_connection_order>
          <bo_connection_description>Business Transaction (For Accounting) - Accounting Notification --&gt; Copy of Sales and Service Document for Accounting - Copy of Sales and Service Document for Accounting</bo_connection_description>
          ...
          <reference_field_keys>
            <reference_field_key>
              ...
              <reference_field_name>FIA_ACC_NOTIF-ROOT-FIA_FAV_SLS_SRV_DOC-ROOT</reference_field_name>
            </reference_field_key>
          </reference_field_keys>
        </Flow>
      </bo_connections>
